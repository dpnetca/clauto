#!/usr/bin/env python
"""
Get a list of all calling search spaces
...
list_partition_data = {"searchCriteria": {"name": "%"}, "returnedTags": {}}

partition_list = service.listRoutePartition(**list_partition_data)

for partition in partition_list["return"]["routePartition"]:
    partition_detail = service.getRoutePartition(uuid=partition["uuid"])
    print(partition_detail["return"]["routePartition"]["name"])
