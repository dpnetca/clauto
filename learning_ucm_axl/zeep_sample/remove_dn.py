"""
Connect to UCM remove a Directory Number
...
line_details = {"pattern": "8888", "routePartitionName": {"_value_1": "dn"}}
try:
    line = service.removeLine(**line_details)
except Fault as f:
    print(f"Unable to remove Line: {f}")
    sys.exit(1)
