...
add_css_data = {
    "name": "dp-test-css",
    "description": "Denis test CSS with AXL",
    "members": {"member": []},
}

try:
    add_css_resp = service.addCss(add_css_data)
    # print(add_css_resp)
except Fault as f:
...
try:
    get_css_resp = service.getCss(uuid=add_css_resp["return"])
    # print(get_css_resp)
except Fault as f:
    print(f"Unable to get CSS: {f}")
    sys.exit(1)
